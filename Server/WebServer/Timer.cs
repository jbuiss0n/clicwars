...
namespace WebServer
{
	...
	{
		private Action m_onTick;

		public EventTimer(TimeSpan delay, TimeSpan interval, Action onTick)
			: base(delay, interval)
		{
			m_onTick = onTick;
		}

		public EventTimer(TimeSpan delay, TimeSpan interval, int count, Action onTick)
			: base(delay, interval, count)
		{
			m_onTick = onTick;
		}
	...
	public class LogoutTimer : Timer
	{
		...
		public LogoutTimer(PlayerMobile player)
